...
@section('title', 'Psixologiya Mətnini Redaktə Et')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Psixologiya Mətnini Redaktə Et</h4>
                                            ...
                                            <div class="tab-content p-3 text-muted">
                                                <div class="tab-pane active" id="az" role="tabpanel">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="text_az" class="form-control @error('text_az') is-invalid @enderror">{{ old('text_az', $psychologyText->text_az) }}</textarea>
                                                ...
                                                <div class="tab-pane" id="en" role="tabpanel">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="text_en" class="form-control @error('text_en') is-invalid @enderror">{{ old('text_en', $psychologyText->text_en) }}</textarea>
                                                ...
                                                <div class="tab-pane" id="ru" role="tabpanel">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="text_ru" class="form-control @error('text_ru') is-invalid @enderror">{{ old('text_ru', $psychologyText->text_ru) }}</textarea>
