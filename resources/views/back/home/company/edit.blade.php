                                                ...
                                                <div class="tab-content p-3 text-muted">
                                                    <div class="tab-pane active" id="az" role="tabpanel">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name_1_az" class="form-control" value="{{ old('name_1_az', $company->name_1_az) }}">
                                                            @error('name_1_az')
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name_2_az" class="form-control" value="{{ old('name_2_az', $company->name_2_az) }}">
                                                            @error('name_2_az')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="tab-pane" id="en" role="tabpanel">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name_1_en" class="form-control" value="{{ old('name_1_en', $company->name_1_en) }}">
                                                            @error('name_1_en')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name_2_en" class="form-control" value="{{ old('name_2_en', $company->name_2_en) }}">
                                                            @error('name_2_en')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="tab-pane" id="ru" role="tabpanel">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name_1_ru" class="form-control" value="{{ old('name_1_ru', $company->name_1_ru) }}">
                                                            @error('name_1_ru')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name_2_ru" class="form-control" value="{{ old('name_2_ru', $company->name_2_ru) }}">
                                                            @error('name_2_ru')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            @if($company->image)
                                                <div class="mt-2">
                                                    <img src="{{ asset($company->image) }}" alt="" style="max-width: 200px; height: auto;">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="status" class="form-select">
                                                <option value="1" {{ $company->status ? 'selected' : '' }}>Aktiv</option>
                                                <option value="0" {{ !$company->status ? 'selected' : '' }}>Deaktiv</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
