        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Vizyonu Yenilə</h4>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.about.vision.update', $vision->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="tab-content p-3 text-muted">
                                                ...
                                                <div class="tab-pane active" id="az" role="tabpanel">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name_1_az" class="form-control @error('name_1_az') is-invalid @enderror" value="{{ old('name_1_az', $vision->name_1_az) }}">
                                                        @error('name_1_az')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Mətn 1 (AZ)</label>
                                                        <textarea name="text_1_az" class="form-control @error('text_1_az') is-invalid @enderror">{{ old('text_1_az', $vision->text_1_az) }}</textarea>
                                                        @error('text_1_az')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Ad 2 (AZ)</label>
                                                        <input type="text" name="name_2_az" class="form-control @error('name_2_az') is-invalid @enderror" value="{{ old('name_2_az', $vision->name_2_az) }}">
                                                        @error('name_2_az')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Mətn 2 (AZ)</label>
                                                        <textarea name="text_2_az" class="form-control @error('text_2_az') is-invalid @enderror">{{ old('text_2_az', $vision->text_2_az) }}</textarea>
                                                ...
                                                <div class="tab-pane" id="en" role="tabpanel">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name_1_en" class="form-control @error('name_1_en') is-invalid @enderror" value="{{ old('name_1_en', $vision->name_1_en) }}">
                                                        @error('name_1_en')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Text 1 (EN)</label>
                                                        <textarea name="text_1_en" class="form-control @error('text_1_en') is-invalid @enderror">{{ old('text_1_en', $vision->text_1_en) }}</textarea>
                                                        @error('text_1_en')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Name 2 (EN)</label>
                                                        <input type="text" name="name_2_en" class="form-control @error('name_2_en') is-invalid @enderror" value="{{ old('name_2_en', $vision->name_2_en) }}">
                                                        @error('name_2_en')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Text 2 (EN)</label>
                                                        <textarea name="text_2_en" class="form-control @error('text_2_en') is-invalid @enderror">{{ old('text_2_en', $vision->text_2_en) }}</textarea>
                                                ...
                                                <div class="tab-pane" id="ru" role="tabpanel">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name_1_ru" class="form-control @error('name_1_ru') is-invalid @enderror" value="{{ old('name_1_ru', $vision->name_1_ru) }}">
                                                        @error('name_1_ru')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Текст 1 (RU)</label>
                                                        <textarea name="text_1_ru" class="form-control @error('text_1_ru') is-invalid @enderror">{{ old('text_1_ru', $vision->text_1_ru) }}</textarea>
                                                        @error('text_1_ru')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Имя 2 (RU)</label>
                                                        <input type="text" name="name_2_ru" class="form-control @error('name_2_ru') is-invalid @enderror" value="{{ old('name_2_ru', $vision->name_2_ru) }}">
                                                        @error('name_2_ru')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Текст 2 (RU)</label>
                                                        <textarea name="text_2_ru" class="form-control @error('text_2_ru') is-invalid @enderror">{{ old('text_2_ru', $vision->text_2_ru) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select @error('status') is-invalid @enderror">
                                        <option value="1" {{ old('status', $vision->status) == 1 ? 'selected' : '' }}>Aktiv</option>
                                        <option value="0" {{ old('status', $vision->status) == 0 ? 'selected' : '' }}>Deaktiv</option>
                                    </select>
