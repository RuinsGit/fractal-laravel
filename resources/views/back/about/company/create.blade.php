        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Yeni Məlumat</h4>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.about.company.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="tab-content p-3 text-muted">
                                                <div class="tab-pane active" id="az" role="tabpanel">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="description_az" class="form-control @error('description_az') is-invalid @enderror" rows="7">{{ old('description_az') }}</textarea>
                                                ...
                                                <div class="tab-pane" id="en" role="tabpanel">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="description_en" class="form-control @error('description_en') is-invalid @enderror" rows="7">{{ old('description_en') }}</textarea>
                                                ...
                                                <div class="tab-pane" id="ru" role="tabpanel">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="description_ru" class="form-control @error('description_ru') is-invalid @enderror" rows="7">{{ old('description_ru') }}</textarea>
