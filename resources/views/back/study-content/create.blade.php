        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Təhsil Məzmunu əlavə et</h4>
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('admin.study-content.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        <div class="mb-3">
                                            <label class="form-label">Mətn (Az)</label>
                                            <input type="text" name="text_az" value="{{ old('text_az') }}" class="form-control">
                                            @error('text_az')
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="text_en" value="{{ old('text_en') }}" class="form-control">
                                            @error('text_en')
                                                <div class="invalid-feedback" style="display: block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="text_ru" value="{{ old('text_ru') }}" class="form-control">
                                            @error('text_ru')
                                                <div class="invalid-feedback" style="display: block">{{ $message }}</div>
                                            @enderror
                                        </div>
        ...
        $(document).ready(function() {
            ...
            $('form').on('submit', function(e) {
                ...
                if (!$('select[name="status"]').val()) {
                    errorMessage += 'Zəhmət olmasa, status seçin<br>';
                    hasError = true;
                }
