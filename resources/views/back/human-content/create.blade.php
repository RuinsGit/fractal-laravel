...
@section('title', 'Yeni İnsan Məzmunu')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Yeni İnsan Məzmunu</h4>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.human-content.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
